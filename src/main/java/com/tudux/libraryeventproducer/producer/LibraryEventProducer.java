...
public class LibraryEventProducer {
    ...
    public void sendLibraryEventAsync1(LibraryEvent libraryEvent) throws JsonProcessingException {
    ...
    public void sendLibraryEvent_Async2(LibraryEvent libraryEvent) throws JsonProcessingException {
    ...
    private ProducerRecord<Integer, String> buildProducerRecord(Integer key, String value, String topic) {
    	...
    	//Only works in Java >=9, method List.of does not exist in Java 8

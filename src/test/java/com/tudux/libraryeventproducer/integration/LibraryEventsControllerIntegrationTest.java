...
public class LibraryEventsControllerIntegrationTest {
    ...
    void postLibraryEvent () throws InterruptedException {
    	...
    	//when
    	ResponseEntity<LibraryEvent> responseEntity = restTemplate.exchange("/v1/libraryevent/sync", HttpMethod.POST,request, LibraryEvent.class);
        ...
        //Thread.sleep(5000);
        String expectedRecord ="{\"libraryEventId\":null,\"libraryEventType\":\"NEW\",\"book\":{\"bookId\":123,\"bookName\":\"Test Book Name\",\"bookAuthor\":\"Test Author\"}}";
